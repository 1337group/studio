...
## 12. Brand mark — the ShapeShifter knot

Asset: `assets/shapeshifter-knot-gold-on-black.png` (gold linework on a
...
```css
.shapeshifter-mark {
  background: #0b0b0d url("/assets/shapeshifter-knot-gold-on-black.png")
              center / 74% no-repeat;
  border-radius: 999px;
...
These ride along with the design system across every ShapeShifter project.
...
ShapeShifter brand reads quiet/serious — emoji noise undercuts that. Status
