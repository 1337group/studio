...
export const shapeshifterOverrides: ShapeShifterOverrideMap = {
  ...
  de: {
    'app.brand': 'Studio',
    'app.brandPill': 'Beta',
    'app.brandSubtitle': 'von ShapeShifter',
    'settings.welcomeTitle': 'Studio by ShapeShifter einrichten',
  },
  'es-ES': {
    'app.brand': 'Studio',
    'app.brandPill': 'Beta',
    'app.brandSubtitle': 'por ShapeShifter',
    'settings.welcomeTitle': 'Configurar Studio by ShapeShifter',
  },
  ja: {
    'app.brand': 'Studio',
    'app.brandPill': 'ベータ',
    'app.brandSubtitle': 'by ShapeShifter',
    'settings.welcomeTitle': 'Studio by ShapeShifter をセットアップ',
  },
  ko: {
    'app.brand': 'Studio',
    'app.brandPill': '베타',
    'app.brandSubtitle': 'by ShapeShifter',
    'settings.welcomeTitle': 'Studio by ShapeShifter 설정',
  },
  pl: {
    'app.brand': 'Studio',
    'app.brandPill': 'Beta',
    'app.brandSubtitle': 'od ShapeShifter',
    'settings.welcomeTitle': 'Skonfiguruj Studio by ShapeShifter',
  },
  hu: {
    'app.brand': 'Studio',
    'app.brandPill': 'Béta',
    'app.brandSubtitle': 'a ShapeShifter által',
    'settings.welcomeTitle': 'Studio by ShapeShifter beállítása',
  },
};
